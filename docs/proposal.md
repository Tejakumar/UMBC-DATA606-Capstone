...
6. **AGE:** Age in years
7. **PAY_0** to **PAY_6:** Repayment status from April to September 2005(-2 = paid fully and no transactions, -1=paid fully but account has a positive balance, 0 = minimum due paid, 1 to 9 = No. of months delayed)
