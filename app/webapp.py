...
for row in input_rows:
    ...
    if row == input_rows[0]:
        st.markdown("<div style='text-align: center;'><h3>Payment Status of</h3></div>", unsafe_allow_html=True)
    if row == input_rows[1]:
        st.markdown("<div style='text-align: center;'><h3>Bill Ammount of </h3></div>", unsafe_allow_html=True)
